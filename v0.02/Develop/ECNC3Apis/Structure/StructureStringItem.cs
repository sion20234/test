...
namespace ECNC3.Models
{
	...
	public class StructureStringItem : IDisposable, ICloneable
	{
		/// <summary>Dispose()関数が呼び出し済みであるかどうかのフラグ</summary>
		private bool _disposed = false;
		/// <summary>コンストラクタ</summary>
		public StructureStringItem()
		{
		}
		/// <summary>番号</summary>
		...
		public object Clone()
		{
            StructureStringItem temp = new StructureStringItem();
			temp.Name = Name;
			temp.Value = Value;
			return temp;
		}
		...
		public ResultCodes Read( XElement root )
		{
			...
			Value = xml.GetAttrText( root, "value" );
