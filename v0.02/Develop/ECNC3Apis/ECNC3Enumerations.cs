...
namespace ECNC3.Enumeration
{
    ...
    public enum MacroRangeLimit
    {
        ...
        /// ラダーマクロ変数（MC→PLC）
        /// </summary>
        LadderSendPLCStart = 2000,
        LadderSendPLCEnd = 2499,
        /// <summary>
        /// ラダーマクロ変数（MC←PLC）
        /// </summary>
        LadderReceivePLCStart = 2500,
        LadderReceivePLCEnd = 2999,
        /// <summary>
        /// 拡張グローバルマクロ変数
        /// </summary>
        ExtGlobalStart = 10000,
        ExtGlobalEnd = 99999
    }
