...
namespace ECNC3.Views
{
	...
	public partial class NumericTextBox : TextBox
	{
		...
		public enum FormatTypes
		{
			...
			Integer1,
            /// <summary>整数2桁 符号なし</summary>
            Integer2,
            /// <summary>整数3桁 符号なし</summary>
            Integer3,
			/// <summary>整数4桁 符号なし</summary>
			Integer4,
			/// <summary>整数5桁 符号なし</summary>
			Integer5,
			/// <summary>整数7桁 符号なし</summary>//2017-07-06：追加：柏原
			Integer7,
			/// <summary>整数9桁 符号なし</summary>//2017-07-06：追加：柏原
			Integer8,
            ...
            /// <summary>整数5桁 符号あり</summary>//2017-09-21：追加：八野
            SignLong5,
