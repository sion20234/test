...
// (2) ファイル名   : ECNCShutdown.cs
// (3) 概要         : OSシャットダウン
// (4) 作成日       : 2016.08.25
// (5) 作成者       : 柏原
// (6) 特記事項     : VisualStudio2017 C#
// (7) 更新履歴     :
//
///////////////////////////////////////////////////////////////////////////////////////////
using System;
...
namespace ECNCShutdown
{
    public partial class Form1 : Form
    {
        ...
        {
            AdjustToken();                                                          //シャットダウンするためのセキュリティ特権を有効
            if(args.Length == 0)
            {
                ExitWindowsEx(ExitWindows.EWX_POWEROFF | ExitWindows.EWX_FORCE, 0); //動作中でも強制シャットダウン
            }
            else
            {//強制で不都合が有る場合、引数を入れるとこちらが動作
                ExitWindowsEx(ExitWindows.EWX_SHUTDOWN, 0); //動作中があれば止まり、なければシャットダウン
            }
        }
        /// <summary>
        /// シャットダウンするためのセキュリティ特権を有効
        /// </summary>
