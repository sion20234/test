...
namespace ECNC3.Models.McIf
{
	...
	public class McReqDryRunEnabled : McCommBasic, IEcnc3McCommand, IDisposable
    {
		...
		public McReqDryRunEnabled()
		{
			ClassName = GetType().Name;
			DataType = Syncdef.REQ_DRYRUN;
			DataTypeName = "REQ_DRYRUN";
			_xmlElementName = "Root/Opr/DryRun";
