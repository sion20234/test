...
{
	/// <summary>4-5-1.オプショナルストップ有効/無効コマンド</summary>
	public class McReqOptionalStopEnabled : McCommBasic, IEcnc3McCommand, IDisposable
    {
		...
		public McReqOptionalStopEnabled()
		{
			ClassName = GetType().Name;
			DataType = Syncdef.REQ_OPTSTOP;
			DataTypeName = "REQ_OPTSTOP";
			_xmlElementName = "Root/Opr/OptStop";
