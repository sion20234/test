...
{
	/// <summary>4-5-2 接触感知有効／無効コマンド</summary>
	public class McReqTouchSensorEnabled : McCommBasic, IEcnc3McCommand, IDisposable
    {
		...
		public McReqTouchSensorEnabled()
		{
			ClassName = GetType().Name;
			DataType = Syncdef.REQ_TOUCHSENSE;
			DataTypeName = "REQ_TOUCHSENSE";
			_xmlElementName = "Root/Opr/TchSnsr";
