...
{
	/// <summary>4-5-7.電極消耗時の自動電極交換有効/無効コマンド</summary>
	public class McReqAecByLifeEnabled : McCommBasic, IEcnc3McCommand, IDisposable
    {
		...
		public McReqAecByLifeEnabled()
		{
			ClassName = GetType().Name;
			DataType = Syncdef.REQ_ELCTDCHGEN;
			DataTypeName = "REQ_ELCTDCHGEN";
			_xmlElementName = "Root/Opr/ElctExchg";
			_xmlAttributeName = "enbl";
		}
		/// <summary>有効／無効設定</summary>
